...
<section class="homepage-reviews-carousel__container">
            ...
            <div class="swiper-slide">
                <div class="v2homepage__reviews-card v2homepage__reviews-card-styles">
                    <div class="v2homepage__reviews-card-comments">
                        "{{ substr($review['comments'], 0, 350) }}
                        @if (strlen($review['comments']) > 350)
                            <details class="v2homepage__reviews-card-read-more">
                                <summary class="v2homepage__reviews-card-read-more">..read more</summary>
                            </details>
                        @endif
                    </div>
